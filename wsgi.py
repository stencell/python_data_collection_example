...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://user:mypassword@postgresdb/height_collector'
db = SQLAlchemy(app)
...
@app.route("/success", methods=['POST']) # by default, route only answers GET requests
def success():
